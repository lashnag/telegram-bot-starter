...
class UpdatesScheduler(
    ...
    @Scheduled(fixedRateString = "\${telegram-bot-starter.scheduler.updates-fixed-rate:1000}", initialDelayString = "\${telegram-bot-starter.scheduler.updates-initial-delay:1000}")
    fun getUpdates() {
        try {
